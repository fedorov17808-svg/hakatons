...
from routes.attestcoin import router as attestcoin_router
app.include_router(quant_router)
app.include_router(verification_router)
app.include_router(attestcoin_router)
...
EXTENDED_ABI_JSON = '''[
    ...
    {"inputs":[{"internalType":"address","name":"_assetAddress","type":"address"},{"internalType":"uint8[7]","name":"_scores","type":"uint8[7]"},{"internalType":"bytes32","name":"_dataHash","type":"bytes32"},{"internalType":"bytes32","name":"_aiDigest","type":"bytes32"},{"internalType":"uint64","name":"_chainKey","type":"uint64"},{"internalType":"uint64[]","name":"_headerNumbers","type":"uint64[]"},{"internalType":"bytes[]","name":"_encodedTransactions","type":"bytes[]"},{"components":[{"internalType":"bytes32","name":"root","type":"bytes32"},{"components":[{"internalType":"bytes32","name":"hash","type":"bytes32"},{"internalType":"bool","name":"isLeft","type":"bool"}],"internalType":"struct MerkleSibling[]","name":"siblings","type":"tuple[]"}],"internalType":"struct MerkleProof[]","name":"_merkleProofs","type":"tuple[]"},{"components":[{"internalType":"bytes32","name":"lowerEndpointDigest","type":"bytes32"},{"internalType":"bytes32[]","name":"roots","type":"bytes32[]"}],"internalType":"struct ContinuityProof","name":"_continuityProof","type":"tuple"}],"name":"saveVerifiedRiskReport","outputs":[{"internalType":"bytes32","name":"queryId","type":"bytes32"}],"stateMutability":"nonpayable","type":"function"}
]'''
